  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto p-2 lg:p-0">
        <div>
          <h2 className="text-[#DA1E49] font-bold text-xl tracking-normal text-center lg:text-4xl">
          ...
          <p>
            ...
            spectrum of exciting slot machines that will keep you on the edge of
            your seat. From classic three-reel slots to contemporary five-reel
            video slots with thrilling bonus rounds, there is a slot game for
            everyone.
          </p>
          <p>
          ...
          <p>
            ...
            will transport you back in time if you enjoy old-school slots.
            Usually, these games have straightforward rules including a single
            payline and frequent symbols include bars, fruits, and sevens. This
          ...
          <p>
            ...
            the pictures and music are meant to draw you into other locations
            and times.
          </p>
        </div>
        <div>
          <div>
            <h3>Progressive Jackpots: Your Chance to Win a Lot of Money</h3>
            <p>
              At 8k8, we know that the chance to win huge amounts of money is
              one of the main reasons people play slots. Because of this, we
              have a number of progressive jackpot slots. These games have
              prizes that get bigger with each spin until someone wins the
              jackpot. These games have big jackpots that are shared together
              and can grow to huge amounts. With just one lucky spin, you could
              win a lot of money.
            </p>

            <p>
              Our progressive jackpot slots have fun themes and ways to play
              that let you enjoy the thrill of winning while you try to get that
              big prize that could change your life. At 8k8, some of the most
              popular progressive slots are Mega Moolah, Major Millions, and
              Hall of Gods. These games give you a chance to win a huge prize.
            </p>

            <p>
              8k8 always keeps things interesting by adding new slot games to
          ...
          <div>
            <h3>Why Should You Play Slots at 8k8?</h3>
            <ul>
              <li>
                <strong>Variety of different games: </strong>
                <p>
                  From old-school 3-reel slots to new-age 5-reel video slots and
                  big jackpots, so there is something for every player.
                </p>
              </li>
              ...
              <li>
                ...
                <p>
                  You can play on the go with our fully designed phone platform.
                </p>
              </li>

              <li>
                <strong>Exciting Bonuses: </strong>
                <p>
                  Use our slot promotions, like free spins and welcome bonuses,
                  to your benefit.
                </p>
              </li>
              ...
              <li>
                ...
                <p>
                  Thanks to cutting edge security technology, you can play
                  without worrying about the safety of your account and data.
                </p>
              </li>
            </ul>
          </div>
