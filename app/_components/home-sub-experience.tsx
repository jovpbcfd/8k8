import WhyShouldPlay from "./home-play";
      ...
      <div className="max-w-6xl mx-auto p-2 lg:p-0">
        <div className="text-justify rounded-lg">
          ...
          <p className="mb-2 text-black lg:mb-5">
            ...
            get bigger with each spin until someone wins the jackpot. These
            games have big jackpots that are shared together and can grow to
            huge amounts. With just one lucky spin, you could win a lot of
            money.
          </p>
          ...
          <p className="mb-2 text-black lg:mb-5">
            ...
            progressive slots are Mega Moolah, Major Millions, and Hall of Gods.
          ...
          <p className="mb-2 text-black lg:mb-5">
            ...
            ways to play, and special bonus features that are sure to keep you
            amused. You&lsquo;ll always be at the cutting edge of online slot
          ...
          <p className="mb-2 text-black lg:mb-5">
            ...
            entertaining elements like Starburst, Gonzo&lsquo;s Quest, and Book
            of Dead. You&lsquo;ll have no trouble locating something you like
            whether you wish to return to an old favorite or experiment with
            something fresh.
          </p>
        </div>
        ...
        <div className="text-justify rounded-lg lg:mt-6">
          ...
          <p className="mb-2 text-black lg:mb-5">
            ...
            you&lsquo;re moving. Just like our PC slots, our mobile slots look
          ...
          <p className="mb-2 text-black lg:mb-5">
            ...
            action right away by downloading the 8k8 app or playing straight in
            your mobile browser.
          </p>
        </div>
        <WhyShouldPlay />
