      ...
      <div className="max-w-6xl mx-auto p-2 lg:p-0">
        <div>
          ...
          <p className="text-justify">
            ...
            hard work. You could win a prize worth up to P88,888 all at once,
            and as you get more active users, your bonus could go over P160,000
            all together. Your bonus will go up as you bring in more people.
            This method makes sure that your dedication and hard work are always
            seen. As an 8k8.com dealer, you can start making money right away
            and watch it grow!
          </p>
        </div>
      </div>
