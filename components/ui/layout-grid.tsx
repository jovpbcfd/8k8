...
type Card = {
  ...
  className: string;
  thumbnail: string;
  previewContent: JSX.Element | React.ReactNode;
};
...
export const LayoutGrid = ({ cards }: { cards: Card[] }) => {
  ...
  // w-full h-full p-10 grid grid-cols-1 md:grid-cols-3  max-w-7xl mx-auto gap-4 relative
  ...
  return (
    <div className="bg-transparent h-full w-full flex flex-col justify-end rounded-lg shadow-2xl relative z-[60]">
      ...
      <motion.div
        ...
        className="relative px-8 pb-4 z-[70] w-full overflow-y-auto"
      >
        {selected?.content}
      </motion.div>
    </div>
